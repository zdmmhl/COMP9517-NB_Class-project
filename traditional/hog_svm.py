"""HOG feature extraction and linear SVM experiment pipeline."""
...
def parse_args():
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("results/hog_svm"))
    parser.add_argument("--cache-dir", type=Path, default=Path("feature_cache/hog"))
